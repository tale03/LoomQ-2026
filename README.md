...
- **L1 通用中间层** — OpenQASM 2.0 → SpinQ / OriginQ / Braket 三后端转译与执行，支持 12 门白名单，两台真机验证通过
- **L2 智能体** — 自然语言生成代码、修复代码、智能选后端，内置自动验证与重试
- **L3 混合编译** — Hybrid-QASM → 量子操作 + RISC-V 汇编
- **RISC-V 量子扩展** — 自定义指令集，量子-经典统一指令流
- **前端界面** — 双语交互、零基础引导、量子概念可视化
